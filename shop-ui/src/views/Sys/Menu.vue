<template>
  <div class="page-container">
	...
	<!--表格树内容栏-->
    <el-table row-key="id" :data="tableTreeDdata" stripe size="mini" style="width: 100%;"
        ...
        <el-form-item v-if="dataForm.type === 1" label="菜单路由" prop="url">
          <el-row>
            ...
            <el-col :span="2" class="icon-list__tips">
				...
				<el-form-item prop="showStatus"  label="是否展示">
					<el-select v-model="dataForm.showStatus" placeholder="请选择">
